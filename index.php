...
<?php 
	if(!isset($_SESSION['login_id']))
	    header('location:quran_list.php');
...
<div class="wrapper">
  ...
  <div class="content-wrapper  bg-dark">
    ...
    <section class="content">
      <?php $page = isset($_GET['page']) ? $_GET['page']:'music_list' ?>
  ...
  <footer class="main-footer bg-black">
    <strong>Copyright &copy; 2023 <a href="https://www.sourcecodester.com/">Designed by Muange</a>.</strong>
    All rights reserved.
